...
//                            require('connexion/function.php');
                           // require ('connexion/connectpg.php');
                            ...
                            try {
                                $nomtab102 = "tab_depot";
                                $tab102 = array('id_projet' => $_POST['catprojet'],'idmarche' => $_POST['marche'],'id_fournisseurs' => $_POST['id_fournisseurs'],'nom_deposant' => $_POST['nomp'],'contact' => $_POST['tel'],'date_soumss' =>$soumiss ,'coutoffre' =>$_POST['coffre']  , 'datenr' => gmdate("Y-m-d H:i:s"),'id_ajout' => $_SESSION['id']);
                                var_dump($tab102);
                            ...
                            <div class="row">
                                  ...
                                  <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input  type="text" class="form-control" placeholder="" id="coffre" name="coffre" style="background-color: rgba(251,199,44,0.54); font-weight: bold; font-size: 16px" >
