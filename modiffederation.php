...
<div class="outer">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        if (isset($_GET['id'])){
                            $id =$_GET['id'];
                        $rsg = $bdd->prepare('select * from table_federal  WHERE id_fed   =:zid  ');
    ...
    try {
        ...
        $rsql1 = $bdd->prepare('UPDATE  table_federal SET  nomf_f = :nomf_f,  contact_f = :contact_f, email_f = :email_f,
                            siege_f = :siege_f,  nbrec_f = :nbrec_f,idcr = :idcr,datenrf = :datenrf,id_modif = :id_modif WHERE id_fed = :id ');
        //  print_r($rsql1);
        $tab = $rsql1->execute(array('nomf_f' => $_POST['nomf_f'],  'contact_f' => $_POST['contact_f'], 'email_f' => $_POST['email_f'], 'siege_f' => $_POST['siege_f'], 
            'nbrec_f' => $_POST['nbrec_f'],'idcr' => 
            $_POST['region'],'datenrf' => gmdate("Y-m-d H:i:s"),'id_modif' => $_SESSION['id'], 'id' =>$id ));
  } catch (Exception $e) {
        die("Erreur ! " . $e->getMessage());
    }
    header("location:?page=listfederation");
                        ...
                        <form class="form-horizontal login_validator" id="form_inline_validator" action=""  method="post" enctype="multipart/form-data">
                             <br>
                            <h4 style="margin-top: 5px; margin-bottom: 10px">Modifier une Fédération </h4>
                            <hr>
                            <!--############################### -->
                             <div class="row">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control chzn-select" name="region">
                                            ...
                                            while($rowcat = $rscat->fetch()) {
                                                ?>
                                                <option value="<?php echo $rowcat['idregion'] ?>" <?php if(isset($rowg['idcr']) && $rowg['idcr']==$rowcat['idregion']){ echo "selected";} ?>><?php echo $rowcat['nomr'] ?></option>
                            ...
                            <div class="row">    
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Nom</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="nomf_f"  value="<?php if(isset($rowg['nomf_f'])){ echo $rowg['nomf_f'] ;}  ?>">
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Contact</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="contact_f"  value="<?php if(isset($rowg['contact_f'])){ echo $rowg['contact_f'] ;}  ?>">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Email</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="email_f"  value="<?php if(isset($rowg['email_f'])){ echo $rowg['email_f'] ;}  ?>">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div> 
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Siège</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="siege_f"  value="<?php if(isset($rowg['siege_f'])){ echo $rowg['siege_f'] ;}  ?>">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div> 
                            ...
                            <div class="row">                                
                               <div class="col-lg-6 input_field_sections">
                                    <h5>Nombre </h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="nbrec_f"  value="<?php if(isset($rowg['nbrec_f'])){ echo $rowg['nbrec_f'] ;}  ?>">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div>
