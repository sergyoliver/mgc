            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        if (isset($_GET['id'])){
                            $id =$_GET['id'];
                         $rsg = $bdd->prepare("select * from fournisseurs  WHERE id_fournisseurs= :zid");
                         //var_dump($id); 
                        ...
                        if (isset($_POST['ok'])){
                             ...
                             try {
                               ...
                               /// le numero d'ordre
                                    $Num_Registre_com=$rowg['Num_Registre_com'];
                                    $rsg = $bdd->prepare("select * from fournisseurs WHERE Num_Registre_com =:nd and Num_Registre_com <>'$Num_Registre_com'");
                                    $rsg->execute(array('nd'=>$_POST['Num_Registre_com']));
                                    $nb = $rsg->rowCount();
...
if ($nb==0){
    ...
    try {
                            ...
                            $rsql1 = $bdd->prepare('UPDATE  fournisseurs SET Name_entreprise = :Name_entreprise,  Forme_juridique = :Forme_juridique, Num_Registre_com = :Num_Registre_com, NCC = :NCC,Regime_lmposition = :Regime_lmposition,Telephone = :Telephone,site = :site,Adresse_electronique = :Adresse_electronique, Adresse_postale = :Adresse_postale,situationgeo = :situationgeo,description = :description,  Peronne_ressource =:Peronne_ressource,site = :site,datenr = :datenr,id_modif = :id_modif WHERE id_fournisseurs =:id');
                            //var_dump($rsql1);

                            $tab = $rsql1->execute(array('Name_entreprise' => $_POST['Name_entreprise'], 'Forme_juridique' => $_POST['Forme_juridique'], 'Num_Registre_com' => $_POST['Num_Registre_com'],'NCC' => $_POST['NCC'], 'Regime_lmposition' => $_POST['Regime_lmposition'], 'Telephone' => $_POST['Telephone'],'site' => $_POST['site'], 'Adresse_electronique' => $_POST['Adresse_electronique'], 'Adresse_postale' => $_POST['Adresse_postale'], 'situationgeo' => $_POST['situationgeo'], 'description' => $_POST['description'], 'Peronne_ressource' => $_POST['Peronne_ressource'],'site' => $_POST['site'], 'datenr' => gmdate("Y-m-d H:i:s"),'id_modif' => $_SESSION['id'],'id' =>$id));
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="Name_entreprise" value="<?php if(isset($rowg['Name_entreprise'])){ echo $rowg['Name_entreprise'] ;}  ?>">
                                  ...
                                  <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="Forme_juridique" value="<?php if(isset($rowg['Forme_juridique'])){ echo $rowg['Forme_juridique'] ;}  ?>">
                                        <span class="input-group-addon"> <i class="fa fa-file  text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <!-- ################################### -->
                             <div class="row">
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="Num_Registre_com" value="<?php if(isset($rowg['Num_Registre_com'])){ echo $rowg['Num_Registre_com'] ;}  ?>" >
                                        <span class="input-group-addon"> <i class="fa fa-file  text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                                  <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="Regime_lmposition" value="<?php if(isset($rowg['Regime_lmposition'])){ echo $rowg['Regime_lmposition'] ;}  ?>">
                                        <span class="input-group-addon"> <i class="fa fa-file  text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <!-- ##################################### -->
                             <div class="row">
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="situationgeo" value="<?php if(isset($rowg['situationgeo'])){ echo $rowg['situationgeo'] ;}  ?>">
                                        <span class="input-group-addon"> <i class="fa fa-file  text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                                 <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="NCC" value="<?php if(isset($rowg['NCC'])){ echo $rowg['NCC'] ;}  ?>">
                                        <span class="input-group-addon"> <i class="fa fa-file  text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <!-- ##################################### -->
                             ...
                             <div class="row">
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Telephone</h5>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="Telephone" value="<?php if(isset($rowg['Telephone'])){ echo $rowg['Telephone'] ;}  ?>">
                                        <span class="input-group-addon"> <i class="fa fa-file  text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                                <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="Adresse_electronique" value="<?php if(isset($rowg['Adresse_electronique'])){ echo $rowg['Adresse_electronique'] ;}  ?>">
                                        <span class="input-group-addon"> <i class="fa fa-file  text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <!-- ##################################### -->
                             <div class="row">
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Site Web</h5>
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="site" value="<?php if(isset($rowg['site'])){ echo $rowg['site'] ;}  ?>">
                                        <span class="input-group-addon"> <i class="fa fa-file  text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                            ...
                            <!-- ##################################### -->
                             <div class="row">
                                 ...
                                 <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="Peronne_ressource" value="<?php if(isset($rowg['Peronne_ressource'])){ echo $rowg['Peronne_ressource'] ;}  ?>">
                                        <span class="input-group-addon"> <i class="fa fa-file  text-primary"></i>
                                        </span>
                                    </div>
                                </div>
                           ...
                           <div class="row">
                            ...
                            <div  class="col-lg-12 input_field_sections">
                                ...
                                <div class="form-group">
                                    <textarea id="summernote"  name="description" rows="10" cols="100">
                                              
                                    <?php if(isset($rowg['description'])){ echo $rowg['description'] ;}  ?>
                                    </textarea>
                                </div>
                            </div></center>
                        </div>
