    ...
    <div class="main-bar row">
        ...
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="breadcrumb-item">
                    <a href="?page=ajoutdistrict">Ajouter district</a>
                </li>
                <li class="active breadcrumb-item"> Liste des districts</li>
            </ol>
        </div>
    </div>
</header>
            ...
            <div class="col-lg-12">
                <div class="card m-t-35">
                         <div class="card-header bg-white">
                            <i class="fa fa-table"></i> Liste des districts
                        </div>
                        <div class="card-block m-t-35">
                            <div class="btn-group" style="margin-bottom: 10px;">    
                                        <a href="?page=ajoutdistrict" id="editable_table_new" class=" btn btn-default">
                                        Ajouter district &nbsp;<i class="fa fa-plus "></i>
                                        </a>                          
                            ...
                            <table id="example1"  class="table2excel display table table-stripped table-bordered">
                                ...
                                <?php
                                $i=1;
                                $rsg = $bdd->prepare('select * from table_district  ORDER by id  ASC ');
                                $rsg->execute();
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $rowg['nomp']; ?></td>
                                    <td><?php echo $rowg['emaild']; ?></td>
                                    <td><?php echo $rowg['siege']; ?></td>                            
                                    <td>
                                        <div class="dropdown no-bg">
                                        </div>
                                            <a href="?page=modifdistrict&id=<?php echo $rowg['id']; ?>" class="todoedit">
