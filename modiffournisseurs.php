...
//                            require('connexion/function.php');
                            ...
                            try {
                                $rsql23 = $bdd->prepare('UPDATE  fournisseurs SET type_prest = :type_prest, typefournisseurs = :typefournisseurs,nom_rep = :nom_rep,  situationgeo = :situationgeo, Telephone = :Telephone, Adresse_electronique = :Adresse_electronique,Adresse_postale = :Adresse_postale,description = :description,  site =:site,Peronne_ressource = :Peronne_ressource,datemodif = :datemodif,id_modif = :id_modif WHERE id_fournisseurs =:id');
                                $tab23 = $rsql23->execute( array('type_prest' => $typeprest2,'typefournisseurs' => $_POST['actif'], 'nom_rep' => $_POST['nom'],  'situationgeo' => $_POST['situationgeoind'],'Telephone' => $_POST['phoneind'], 'Adresse_electronique' => $_POST['adresseEind'], 'Adresse_postale' => $_POST['adressPind'], 'description' => $_POST['descind'],'site' => $_POST['siteind'],'Peronne_ressource' => $_POST['persressourceind'],'datemodif' => gmdate("Y-m-d H:i:s"),'id_modif' => $_SESSION['id'],'id' => $_GET['id']));
