    ...
    <div class="main-bar row">
        ...
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="breadcrumb-item">
                    <a href="?page=listfacture">Liste des Facture</a>
                </li>
                <li class="active breadcrumb-item">Reception de nouvelle facture</li>
            </ol>
        </div>
    </div>
</header>
<div class="outer">
    <div class="inner bg-container forms">
        <div class="row">
         ...
         $tab10 = array('Num_Facture' => $_POST['Num_Facture'], 'id_ajout' => $_SESSION['id'], 'Mnt_Facture' => $_POST['Mnt_Facture'],'scan' => $photor, 'date_reception' => formatinv_date($_POST['date_reception']),'Idprojet' => $_POST['catprojet'], 'id_fournisseurs' => $_POST['id_fournisseurs'],'idmarche' => $_POST['marche'],'datenr' => gmdate("Y-m-d H:i:s"));
        // var_dump($tab10);
                           ...
                           <div class="row">
                            ...
                            <div class="row">    
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" name="Mnt_Facture" style="background-color: rgba(255,118,22,0.13); font-weight: bold" >
                                        <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                        </span>
                                    </div>
                                </div>                               
                            ...
                            <div class="row">
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Date Réception</h5>
                                     <div class="input-group">
                                        ...
                                        <input autocomplete="off" type="text" class="form-control" placeholder="jj-mm-aaaa" id="dp8" name="date_reception" >
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input id="input-4" name="scan" type="file"  class="file-loading" required style="display: block">
