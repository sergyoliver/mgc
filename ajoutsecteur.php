                    ...
                    <div class="card-block">
                        ...
                        if (isset($_POST['ok'])){
                            ...
                            if(!empty($scan)) {
                                ...
                                $tmp_ph = $_FILES['desig_sec']['tmp_name'];
                                ...
                                $photor='';
                                    ...
                                    try {
        $nomtab10 = "table_secteur";
        $tab10 = array('noms' => $_POST['noms'], 'id_ajout' => $_SESSION['id'], 'contacts' => $_POST['contacts'],'desig_sec' => $photor,'emails' => $_POST['emails'], 'sieges' => $_POST['sieges'],'nbrecs' => $_POST['nbrecs'],'idfed' => $_POST['feder'],'datenr' => gmdate("Y-m-d H:i:s"));
        // var_dump($tab10);
                           ...
                           <div class="row">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control chzn-select" name="feder">
                                            ...
                                            while($rowcat = $rscat->fetch()) {
                                                ?>
                                                <option value="<?php echo $rowcat['id_fed'] ?>"><?php echo $rowcat['nomf_f'] ?></option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Siège</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="sieges">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div> 
                            ...
                            <div class="row">                                
                               <div class="col-lg-6 input_field_sections">
                                    <h5>Nombre </h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="nbrecs">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-lg-5 push-lg-2">
                                        <button class="btn btn-primary" type="submit" id="ok" name="ok">
                                         ...
                                         <button class="btn btn-warning" type="reset" id="clear">
                                             <a  id="editable_table_new"  href="?page=listsecteur" style="color :white;">
