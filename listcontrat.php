                ...
                <div class="card m-t-35">
                        ...
                        <div class="card-block m-t-35">
                             <div class="btn-group" style="margin-bottom: 10px;">    
                                        ...
                                        Générer un contrat &nbsp;<i class="fa fa-plus btn btn-primary"></i>
                                        </a>                                     
                                </div>
                            <table id="example1"  class="table2excel display table table-stripped table-bordered">
                                ...
                                <tbody>
                                 <?php
                                $i=1;
                                $rsg = $bdd->prepare('select * from  contrat ORDER by id_contrat  ASC ');
                                $rsg->execute();
                                ...
                                ?>
                                    ...
                                    <td><?php echo number_format($rowg['mtn_contrat']); ?></td>
                                    <td>
