    ...
    <div class="main-bar row">
        ...
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="breadcrumb-item">
                    <a href="?page=listfederation">Liste des Federations</a>
                </li>
                <li class="active breadcrumb-item">Ajout d'une  féderation</li>
            </ol>
        </div>
    </div>
</header>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header bg-primary">
                      AJOUT D'UNE FEDERATION
                    </div>
                    <div class="card-block">
                        <?php

                        if (isset($_POST['ok'])){
                            $scan = $_FILES['desig_fed']['name'];
                            if(!empty($scan)) {
                                $tab = explode(".", $scan);
                                ...
                                $tmp_ph = $_FILES['desig_fed']['tmp_name'];
                                ...
                                $photor='';
                                    ...
                                    try {
         $nomtab10 = "table_federal";
         $tab10 = array('nomf_f' => $_POST['nomf_f'], 'id_ajout' => $_SESSION['id'], 'contact_f' => $_POST['contact_f'],'desig_fed' => $photor,'email_f' => $_POST['email_f'], 'siege_f' => $_POST['siege_f'],'nbrec_f' => $_POST['nbrec_f'],'idcr' => $_POST['region'],'datenr' => gmdate("Y-m-d H:i:s"));
        // var_dump($tab10);
         ...
         $sql->execute($tab10);
                      ...
                      header("location:?page=listfederation");
                        ...
                        <form class="form-horizontal login_validator" id="form_inline_validator" action=""  method="post" enctype="multipart/form-data">
                             <br>
                            <h4 style="margin-top: 5px; margin-bottom: 10px"> AJOUT FEDERATION</h4>
                            <hr>
                             <!--############################### -->
                            <div class="row">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control chzn-select" name="region">
                                            ...
                                            while($rowcat = $rscat->fetch()) {
                                                ?>
                                                <option value="<?php echo $rowcat['idregion'] ?>"><?php echo $rowcat['nomr'] ?></option>
                            ...
                            <div class="row">    
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Nom</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="nomf_f">
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Contact</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="contact_f">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Email</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="email_f">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div> 
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Siège</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="siege_f">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div> 
                            ...
                            <div class="row">                                
                               <div class="col-lg-6 input_field_sections">
                                    <h5>Nombre </h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="nbrec_f">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Logo Fédération</h5>
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input id="input-4" name="desig_fed" type="file"  class="file-loading" style="display: block">
                                    ...
                                    <div class="col-lg-5 push-lg-2">
                                        <button class="btn btn-primary" type="submit" id="ok" name="ok">
                                         ...
                                         <button class="btn btn-warning" type="reset" id="clear">
                                             <a  id="editable_table_new"  href="?page=listfederation" style="color :white;">
