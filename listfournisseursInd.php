                ...
                <div class="card m-t-35">
                        ...
                        <div class="card-block m-t-35">
                            <div class="btn-group" style="margin-bottom: 10px;">    
                                        <a href="?page=ajoutfournisseursInd" id="editable_table_new" class=" btn btn-default">
                            ...
                            <table id="example1"  class="table2excel display table table-stripped table-bordered">
                              ...
                              <?php
                                $i=1;
                                $rsg = $bdd->prepare('select * from tab_fournisseursindiv ORDER by id_indiv  ASC ');
                                $rsg->execute(array());
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $rowg['adresseEind']; ?></td>
                                    <td><?php echo $rowg['nom']; ?></td>
                                    <td><?php echo $rowg['situationgeoind']; ?></td>
                                    <td><?php echo $rowg['phoneind']; ?></td>
                                    <td><?php echo $rowg['adresseEind']; ?></td>
                                    <td>

                                        
                                            <a href="?page=modiffournisseursInd&id=<?php echo $rowg['id_indiv']; ?>" class="todoedit">
