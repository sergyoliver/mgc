...
<div class="outer">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        if (isset($_GET['id'])){
                            $id =$_GET['id'];
                        $rsg = $bdd->prepare('select * from table_gab  WHERE id_bdv  =:zid  ');
    ...
    try {
        ...
        $rsql1 = $bdd->prepare('UPDATE  table_gab SET  nom_bdv = :nom_bdv,  contact_bdv = :contact_bdv, email_bdv = :email_bdv,siege_bdv = :siege_bdv,  nbrec_bdv = :nbrec_bdv,idsec = :idsec,datenrf = :datenrf,id_modif = :id_modif WHERE id_bdv = :id ');
        //  print_r($rsql1);
        $tab = $rsql1->execute(array('nom_bdv' => $_POST['nom_bdv'],  'contact_bdv' => $_POST['contact_bdv'], 'email_bdv' => $_POST['email_bdv'], 'siege_bdv' => $_POST['siege_bdv'], 
            'nbrec_bdv' => $_POST['nbrec_bdv'],'idsec' => 
            $_POST['secteur'],'datenrf' => gmdate("Y-m-d H:i:s"),'id_modif' => $_SESSION['id'], 'id' =>$id ));
  } catch (Exception $e) {
                        ...
                        <form class="form-horizontal login_validator" id="form_inline_validator" action=""  method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">    
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Nom</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="nom_bdv"  value="<?php if(isset($rowg['nom_bdv'])){ echo $rowg['nom_bdv'] ;}  ?>">
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Contact</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="contact_bdv"  value="<?php if(isset($rowg['contact_bdv'])){ echo $rowg['contact_bdv'] ;}  ?>">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Email</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="email_bdv"  value="<?php if(isset($rowg['email_bdv'])){ echo $rowg['email_bdv'] ;}  ?>">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div> 
                                <div class="col-lg-6 input_field_sections">
                                    <h5>Siège</h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="siege_bdv"  value="<?php if(isset($rowg['siege_bdv'])){ echo $rowg['siege_bdv'] ;}  ?>">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div> 
