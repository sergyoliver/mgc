    ...
    <div class="main-bar row">
        ...
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="breadcrumb-item">
                    <a href="?page=ajoutregion">Ajouter un secteur</a>
                </li>
                <li class="active breadcrumb-item">   Liste des secteurs</li>
            </ol>
        </div>
    </div>
</header>
            ...
            <div class="col-lg-12">
                <div class="card m-t-35">
                        <div class="card-header bg-white">
                            <i class="fa fa-table"></i> Liste des secteurs
                        </div>
                        <div class="card-block m-t-35">
                            <div class="btn-group" style="margin-bottom: 10px;">    
                                        <a href="?page=ajoutsecteur
                                        " id="editable_table_new" class=" btn btn-default">
                                        Ajouter secteur  &nbsp;<i class="fa fa-plus "></i>
                                        </a>                                     
                            </div>
                            ...
                            <tbody>
                                <?php
                                $i=1;
                                $rsg = $bdd->prepare('select * from table_secteur  ORDER by id_section  ASC ');
                                $rsg->execute();
                                ...
                                <tr>
                                    <td><?php echo $i; ?></td>
                                    <td><?php echo $rowg['noms']; ?></td>
                                    <td><?php echo $rowg['emails']; ?></td>
                                    <td><?php echo $rowg['sieges']; ?></td>
                                   
                                    <td>

                                        <div class="dropdown no-bg">
                                            
                                        <a href="?page=modifsecteur&id=<?php echo $rowg['id_section']; ?>" class="todoedit">
