...
<div  id="wrap">
    ...
    <div class="wrapper">
        <div id="content" class="bg-container2">
            <header class="head" style="background-position:top; background-repeat: repeat-x; background-color: #ff811d; background-image: url(img/kit/haut2.jpg)">
                <div class="main-bar row">
                    ...
                    <div class="col-lg-6 col-md-8 col-sm-8" >
                        <ol class="breadcrumb float-xs-right ">
                            <li class="breadcrumb-item active"><h4>DCP-EMPLOI </h4></li>
                        </ol>
                    </div>
                </div>
            </header>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 push-lg-2 col-md-10 push-md-1 col-sm-12">
                                    ...
                                    <div class="login_logo login_border_radius1" style="text-align: center">
                                        <img src="img/logoaccueil.png?v=<?php echo time()?>"  style="align-content: center; margin-top: 3px">
                                    ...
                                    <div class="login_content login_border_radius " style="border:solid 1px darkorange">
                                    ...
                                    <br>
                                    <div class="row" style="text-align: center; font-size: small; color: #3f6718;"> <div class="form-group">DCP-Emploi @2022 - Tous droits réservés   </div></div>
