                        ...
                        <?php
                         ...
                         $rowp = $rsa->fetch();
                          ...
                          $soumiss = formatinv_date($_POST['date_soumss']);
                            ...
                            try {
                                $rsql1 = $bdd->prepare('UPDATE  tab_depot SET  id_projet = :id_projet,idmarche = :idmarche,  id_fournisseurs = :id_fournisseurs,nom_deposant = :nom_deposant,  contact = :contact,date_soumss = :date_soumss,datenr = :datenr,id_modif = :id_modif WHERE id_depot =:id');
                                //$nomtab102 = "tab_depot";
                                $tab10 = $rsql1->execute(array('id_projet' => $_POST['catprojet'],'idmarche' => $_POST['marche'],'id_fournisseurs' => $_POST['id_fournisseurs'],'nom_deposant' => $_POST['nomp'],'contact' => $_POST['tel'],'date_soumss' =>$soumiss  , 'datenr' => gmdate("Y-m-d H:i:s"),'id_modif' => $_SESSION['id'],'id' => $_GET['id']));
