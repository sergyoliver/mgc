            ...
            <div class="col-lg-12">
                <div class="card m-t-35">
                        <div class="card-header bg-white">
                            <i class="fa fa-table"></i> Listes des transactions
                        </div>
                        <div class="card-block m-t-35">
                            <div class="btn-group" style="margin-bottom: 10px;">    
                                        <a href="?page=ajouttrans" id="editable_table_new" class=" btn btn-default">
                            ...
                            <table id="example1"  class="table2excel display table table-stripped table-bordered">
                              ...
                              <?php
                                $i=1;
                                $rsg = $bdd->prepare('select * from table_transaction ORDER by id_trans  ASC ');
                                $rsg->execute(array());
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $rowg['num_paiem']; ?></td>
                                     
                                <?php
                                $i=1;
                                $ida =$rowg['id_nomadr'];
                                $rsf = $bdd->prepare("select * from  table_adherent  WHERE id_adhr   = :zid");
                                $rsf->execute(array("zid"=>$ida));
                                while($rowf = $rsf->fetch()) {
                                ?>
                                     <td><?php echo $rowf['nom_adh']." ".$rowf['penom_adh']; ?></td>
                                
                                    <td><?php echo $rowg['Date_trans']; ?></td>
                                    
                                    
                                    <td><?php echo $rowf['tel_adh']; ?></td><?php }?>
                                   
                                    <td>

                                        
                                            <a href="?page=modiftrans&id=<?php echo $rowg['id_trans']; ?>" class="todoedit">
                                                <span class="fa fa-pencil"></span>
                                            </a>
                                            <a href="?page=resu&id=<?php echo $rowg['id_trans']; ?>" class="todoedit">
