...
RicoTranslate.addPhrase("Today is","Hoje é")
...
RicoTranslate.addPhrase("to web page","para uma página da Web")
RicoTranslate.addPhrase("to spreadsheet","para um spreadsheet")
