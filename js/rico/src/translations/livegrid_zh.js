...
RicoTranslate.addPhrase("Loading","加载中")
RicoTranslate.addPhrase("minutes before your session expires","离过期还有（以分钟计）")
RicoTranslate.addPhrase("EXPIRED","已过期")
RicoTranslate.addPhrase("Close","关闭")
RicoTranslate.addPhrase("Cancel","取消")
RicoTranslate.addPhrase("Save","保存")
RicoTranslate.addPhrase("Add","添加")
RicoTranslate.addPhrase("Edit","编辑")
RicoTranslate.addPhrase("Delete","删除")
RicoTranslate.addPhrase("Are you sure you want to delete","您确定要删除吗")
RicoTranslate.addPhrase("record","记录")
RicoTranslate.addPhrase("this record","此记录")
RicoTranslate.addPhrase("new record","新记录")
RicoTranslate.addPhrase("Please enter","请输入")
RicoTranslate.addPhrase("a value for","如下字段的值：")
RicoTranslate.addPhrase("an integer value for","如下字段的整数值：")
RicoTranslate.addPhrase("a positive integer value for","如下字段的正整数值：")
RicoTranslate.addPhrase("The request returned an error","该请求返回一个错误")

// for demo only:

RicoTranslate.addPhrase("Show orders for","显示订单")
RicoTranslate.addPhrase("Show order detail","显示订单详情")
RicoTranslate.addPhrase("order","订单")
RicoTranslate.addPhrase("this order","此订单")
RicoTranslate.addPhrase("new order","新订单")
