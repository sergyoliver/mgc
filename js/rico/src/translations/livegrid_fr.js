...
RicoTranslate.addPhrase("Today is","Aujourd'hui est")
...
RicoTranslate.addPhrase("to web page","vers un page Web")
RicoTranslate.addPhrase("to spreadsheet","vers un bilan")
RicoTranslate.addPhrase("Export in progress","Exportation en marche")
RicoTranslate.addPhrase("Exporting row","Exportation de la rangée")
...
RicoTranslate.addPhrase("an integer value","un nombre entier")
RicoTranslate.addPhrase("a positive integer value","un nombre positif")
RicoTranslate.addPhrase("for","pour")
