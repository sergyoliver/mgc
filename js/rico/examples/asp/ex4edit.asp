...
sub DisplayAllTables()
  response.write "<table width='100%'><tr><td colspan=2>"
%>
<!-- #INCLUDE FILE = "menu.vbs" --> 
<%
  response.write "</td></tr><tr valign=top><td width='250'><div class='description'>Double-click on a row to see all orders for that customer."
...
sub DefineCustTable()
  ...
  oForm.options("visibleRows")="body"
...
sub DefineDetailTable()
  ...
  detailTE.AddEntryFieldW "UnitPrice","Unit Price","B","",80
  detailTE.CurrentField("format")="DOLLAR"
  detailTE.AddEntryFieldW "Quantity","Quantity","I","",80
  detailTE.CurrentField("format")="QTY"
  detailTE.AddEntryFieldW "Discount","Discount","B","",80
