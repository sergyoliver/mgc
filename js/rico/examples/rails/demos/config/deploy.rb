...
set :application, 'openrico.org' # The one you are deploying.
...
set :user, "rcowin"
set :txd_primary_domain, 'openrico.org' # The domain you ssh to for your server.
set :lighty_port, 8062 # The port given to you by TextDrive for running lighttpd
...
set :repository, "http://openrico.org/svn/openrico/trunk"
# For svn+ssh.
#set :repository, "svn+ssh://#{user}@#{txd_primary_domain}/home/#{user}/svn/#{application}"

set :deploy_to, "/home/rcowin/web/test
...
task :setup_lighty do  
  ...
  set :lighttpdctrl_restart, "/home/rcowin/lighttpd/lighttpdctrl restart"
  set :lighttpdctrl_start, "/usr/local/sbin/lighttpd -f /home/rcowin/lighttpd/lighttpd.conf"
  run lighttpdctrl_start
  
  #run "/usr/local/sbin/lighttpd -f /home/rcowin/lighttpd/lighttpd.conf"
...
task :restart, :roles => :app do
  run "/home/rcowin/lighttpd/lighttpdctrl restart"
end
