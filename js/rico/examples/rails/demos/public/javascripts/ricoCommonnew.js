...
/*    var cumPos = Position.cumulativeOffset(element)
    var realPos = Position.realOffset(element)

    Position.prepare()    
    return {x:cumPos[0] - realPos[0] - Position.deltaX, y: cumPos[1] - realPos[1] - Position.deltaY}
*/
