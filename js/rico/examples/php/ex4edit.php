...
function DisplayAllTables() {
  ...
  echo "</td></tr><tr valign=top><td width='250'><div class='description'>Double-click on a row to see all orders for that customer.";
...
function DefineDetailTable() {
  ...
  $GLOBALS['detailTE']->AddEntryFieldW("UnitPrice", "Unit Price", "B", "", 80);
  $GLOBALS['detailTE']->CurrentField["format"]="DOLLAR";
  $GLOBALS['detailTE']->AddEntryFieldW("Quantity", "Quantity", "I", "", 80);
  $GLOBALS['detailTE']->CurrentField["format"]="QTY";
  $GLOBALS['detailTE']->AddEntryFieldW("Discount", "Discount", "B", "", 80);
