    ...
    <div class="main-bar row">
        ...
        <div class="col-sm-7 col-lg-6">
            <ol class="breadcrumb float-xs-right nav_breadcrumb_top_align">
                ...
                <li class="active breadcrumb-item">Ajout nouveau district</li>
            </ol>
        </div>
    </div>
</header>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        if (isset($_POST['ok'])){
                            $scan = $_FILES['desig_district']['name'];
                            if(!empty($scan)) {
                                $tab = explode(".", $scan);
                                ...
                                $tmp_ph = $_FILES['desig_district']['tmp_name'];
                                ...
                                $photor='';
                                    ...
                                    try {
         $nomtab10 = "table_district";
         $tab10 = array('nomp' => $_POST['nomp'], 'id_ajout' => $_SESSION['id'], 'contact' => $_POST['contact'],'desig_district' => $photor,'emaild' => $_POST['emaild'], 'siege' => $_POST['siege'],'nbrec' => $_POST['nbrec'],'datenr' => gmdate("Y-m-d H:i:s"));
        // var_dump($tab10);
         ...
         $sql->execute($tab10);
                      ...
                      header("location:?page=listdistricts");
                        ...
                        <form class="form-horizontal login_validator" id="form_inline_validator" action=""  method="post" enctype="multipart/form-data">
                             <br>
                            <h4 style="margin-top: 5px; margin-bottom: 10px">Ajouter un district </h4>
                            <hr>
                            ...
                            <div class="row">                                
                               <div class="col-lg-6 input_field_sections">
                                    <h5>Nombre </h5>
                                    <div class="input-group">
                                    <input type="text" class="form-control" name="nbrec">
                                    <span class="input-group-addon"> <i class="fa fa-file text-primary"></i>
                                    </span>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 input_field_sections">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group">
                                            <input id="input-4" name="desig_district" type="file"  class="file-loading" required style="display: block">
